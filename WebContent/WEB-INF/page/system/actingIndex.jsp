...
<title>待办事宜编辑</title>
<%
	//request.getQueryString();URLDecoder.decode(s);
	 
	 /* new String(request.getParameter("").getBytes(), "utf-8");
	 request.getp */
	 
	 /* private static HashMap<String,String> qqid2Myid;
	 static {
	 	qqid2Myid = new HashMap<String,String>();
	 	qqid2Myid.put("8","s1");
	 } */
%>
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  document.Form1.action="system/elecCommonMsgAction_saveMsg.do";
