	   ...
	   <table cellspacing="0"   cellpadding="1" rules="all" bordercolor="gray" border="1" id="dictTbl"
		    style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
				...
				<s:if test="#request.systemList!=null && #request.systemList.size()>0">
					<s:iterator value="%{#request.systemList}" var="systemDDl">
						<tr>
							<td class="ta_01" align="center" width="20%"><s:property value="%{#systemDDl.ddlCode}"/></td>
							<td class="ta_01" align="center" width="60%"><input id="itemname" name="itemname" type="text" value="<s:property value="%{#systemDDl.ddlname}"/>" size="45" maxlength="25"></td>
							<td class="ta_01" align="center" width="20%"><a href="#" onclick="delTableRow('<s:property value="%{#systemDDl.ddlCode}"/>')"> <img src="../images/delete.gif" width="16" height="16" border="0" style="CURSOR: hand"></a></td>
						</tr>
					</s:iterator>
				</s:if>
				<s:else>
