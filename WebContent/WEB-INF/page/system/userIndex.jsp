...
<HTML>
	...
	<body >
		<s:form id="Form1" name="Form1" action="elecUserAction_home.do" namespace="/system" method="post" cssStyle="margin:0px;"> 
		...
		<s:form id="Form2" name="Form2" action="elecUserAction_home.do" namespace="/system" method="post">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10><td></td></TR>			
				<tr>
